...
# Heuristic: facet keys are typically short (single words or abbreviations).
# 40 chars is chosen as a conservative upper bound; longer keys are likely typos or errors.
